...
| :--- | :--- | :---: |
| HU-S1-01 | Como usuario, quiero consultar un feed social comunitario con relatos de reencuentro, fotos cotidianas y consejos útiles de cuidado animal. | Alta |
| HU-S1-02 | Como usuario, quiero crear publicaciones en el feed comunitario (fotos, anécdotas y consejos de cuidado) para compartir vivencias con la comunidad. | Alta |
